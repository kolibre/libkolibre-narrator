...
bool Narrator::setLanguage(string lang)
{
    ...
    {
        LOG4CXX_DEBUG(narratorLog, "Setting language to: Russian");
    }
    else if (lang == "hy")
    {
        LOG4CXX_DEBUG(narratorLog, "Setting language to: Armenian");
    }
    else if (lang == "af")
    {
        LOG4CXX_DEBUG(narratorLog, "Setting language to: Afrikaans");
    }
    else if (lang == "sq")
    {
        LOG4CXX_DEBUG(narratorLog, "Setting language to: Albanian");
    }
    else if (lang == "ar")
    {
        LOG4CXX_DEBUG(narratorLog, "Setting language to: Arabic");
    }
    else if (lang == "bs")
    {
        LOG4CXX_DEBUG(narratorLog, "Setting language to: Bosnian");
    }
    else if (lang == "cy")
    {
        LOG4CXX_DEBUG(narratorLog, "Setting language to: Welsh");
    }
    else if (lang == "hu")
    {
        LOG4CXX_DEBUG(narratorLog, "Setting language to: Hungarian");
    }
    else if (lang == "vi")
    {
        LOG4CXX_DEBUG(narratorLog, "Setting language to: Vietnamese");
    }
    else if (lang == "el")
    {
        LOG4CXX_DEBUG(narratorLog, "Setting language to: Greek");
    }
    else if (lang == "da")
    {
        LOG4CXX_DEBUG(narratorLog, "Setting language to: Danish");
    }
    else if (lang == "id")
    {
        LOG4CXX_DEBUG(narratorLog, "Setting language to: Indonesian");
    }
    else if (lang == "is")
    {
        LOG4CXX_DEBUG(narratorLog, "Setting language to: Icelandic");
    }
    else if (lang == "it")
    {
        LOG4CXX_DEBUG(narratorLog, "Setting language to: Italian");
    }
    else if (lang == "ca")
    {
        LOG4CXX_DEBUG(narratorLog, "Setting language to: Catalan");
    }
    else if (lang == "zh")
    {
        LOG4CXX_DEBUG(narratorLog, "Setting language to: Chinese");
    }
    else if (lang == "ko")
    {
        LOG4CXX_DEBUG(narratorLog, "Setting language to: Korean");
    }
    else if (lang == "ht")
    {
        LOG4CXX_DEBUG(narratorLog, "Setting language to: Haitian Creole");
    }
    else if (lang == "la")
    {
        LOG4CXX_DEBUG(narratorLog, "Setting language to: Latin");
    }
    else if (lang == "lv")
    {
        LOG4CXX_DEBUG(narratorLog, "Setting language to: Latvian");
    }
    else if (lang == "mk")
    {
        LOG4CXX_DEBUG(narratorLog, "Setting language to: Macedonian");
    }
    else if (lang == "de")
    {
        LOG4CXX_DEBUG(narratorLog, "Setting language to: German");
    }
    else if (lang == "nl")
    {
        LOG4CXX_DEBUG(narratorLog, "Setting language to: Dutch");
    }
    else if (lang == "no")
    {
        LOG4CXX_DEBUG(narratorLog, "Setting language to: Norwegian");
    }
    else if (lang == "pl")
    {
        LOG4CXX_DEBUG(narratorLog, "Setting language to: Polish");
    }
    else if (lang == "pt")
    {
        LOG4CXX_DEBUG(narratorLog, "Setting language to: Portuguese");
    }
    else if (lang == "ro")
    {
        LOG4CXX_DEBUG(narratorLog, "Setting language to: Romanian");
    }
    else if (lang == "sr")
    {
        LOG4CXX_DEBUG(narratorLog, "Setting language to: Serbian");
    }
    else if (lang == "sk")
    {
        LOG4CXX_DEBUG(narratorLog, "Setting language to: Slovak");
    }
    else if (lang == "sw")
    {
        LOG4CXX_DEBUG(narratorLog, "Setting language to: Swahili");
    }
    else if (lang == "th")
    {
        LOG4CXX_DEBUG(narratorLog, "Setting language to: Thai");
    }
    else if (lang == "ta")
    {
        LOG4CXX_DEBUG(narratorLog, "Setting language to: Tamil");
    }
    else if (lang == "tr")
    {
        LOG4CXX_DEBUG(narratorLog, "Setting language to: Turkish");
    }
    else if (lang == "fr")
    {
        LOG4CXX_DEBUG(narratorLog, "Setting language to: French");
    }
    else if (lang == "hi")
    {
        LOG4CXX_DEBUG(narratorLog, "Setting language to: Hindi");
    }
    else if (lang == "hr")
    {
        LOG4CXX_DEBUG(narratorLog, "Setting language to: Croatian");
    }
    else if (lang == "cs")
    {
        LOG4CXX_DEBUG(narratorLog, "Setting language to: Czech");
    }
    else if (lang == "eo")
    {
        LOG4CXX_DEBUG(narratorLog, "Setting language to: Esperanto");
    }
    else if (lang == "ja")
    {
        LOG4CXX_DEBUG(narratorLog, "Setting language to: Japanese");
    }
    else
    {
...
{
    return hasAudio(identifier, "ogg");
}
...
{
    return hasAudio(identifier, "mp3");
}
...
{
    return addAudio(identifier, "ogg", data, size);
}
...
{
    return addAudio(identifier, "mp3", data, size);
}
